...
const Formulario = () => {
  ...
  useEffect(() => {
    if(paciente?.nombre) {
      ...
      setEmail(email);
      setFecha(new Date(fecha).toISOString());
    ...
    <>
      ...
      >
        ...
        <input
          ...
          className="bg-indigo-600 w-full p-3 rounded-xl text-white uppercase font-bold hover:cursor-pointer hover:bg-indigo-700 transition-colors"
        />
      </form>
      {msg && (
        <Alerta
