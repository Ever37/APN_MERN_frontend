  ...
  return (
    <div className="mx-5 my-10 bg-white shadow-md px-5 py-10 rounded-xl">
      ...
      <div className="flex justify-between my-5">
        <button
          type="button"
          className="text-white uppercase font-bold py-2 px-10 bg-indigo-600 hover:bg-indigo-700 rounded-lg"
        ...
        <button
          type="button"
          className="text-white uppercase font-bold py-2 px-10 bg-red-600 hover:bg-red-700 rounded-lg"
